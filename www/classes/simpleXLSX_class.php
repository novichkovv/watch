 ...
 * Time: 15:53
 */
// simpleXLSX_class php class v0.4
// MS Excel 2007 workbooks reader
// Example: 
//   $xlsx = new simpleXLSX_class('book.xlsx');
//   print_r( $xlsx->rows() );
// Example 2: 
//   $xlsx = new simpleXLSX_class('book.xlsx');
//   print_r( $xlsx->rowsEx() );
...
//			$bE = ($aP['GPF'] && 0x0001) ? TRUE : FALSE;
    ...
    function _parse() {
        ...
        foreach ($relations->Relationship as $rel) {
            if ($rel["Type"] == simpleXLSX_class::SCHEMA_OFFICEDOCUMENT) {
                ...
                $workbookRelations->registerXPathNamespace("rel", simpleXLSX_class::SCHEMA_RELATIONSHIP);

                // Read shared strings
                $sharedStringsPath = $workbookRelations->xpath("rel:Relationship[@Type='" . simpleXLSX_class::SCHEMA_SHAREDSTRINGS . "']");
                ...
                foreach ($workbookRelations->Relationship as $workbookRelation) {
                    if ($workbookRelation["Type"] == simpleXLSX_class::SCHEMA_WORKSHEETRELATION) {
