...
function ch(a){"_"==a[0]||bh(a);dh()[a]=ec();eh()["tick_"+a]=void 0;if(Zf("csi_on_gel")){var b=fh();"_start"==a?hg("latencyActionBaselined",{clientActionNonce:b},void 0):hg("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0);a=!0}else a=!1;if(!(a||Zf("navigation_only_csi_reset")&&r("yt.timing.pingSent_"))&&(b=F("TIMING_ACTION",void 0),a=dh(),r("yt.timing.ready_")&&b&&a._start&&gh())){var b=!0,c=F("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}if(b)if(d=
dh(),a=hh().span,e=hh().info,b=r("yt.timing.reportbuilder_")){if(b=b(d,a,e,void 0))ih(b),jh(),ah(),kh(!1)}else{var f=F("CSI_SERVICE_NAME","youtube"),b={v:2,s:f,action:F("TIMING_ACTION",void 0)},c=e.srt;delete e.srt;void 0===d.srt&&(c||0===c||(c=Wg.timing||{},c=Math.max(0,c.responseStart-c.navigationStart),isNaN(c)&&e.pt&&(c=e.pt)),c||0===c)&&(e.srt=Math.round(c));if(e.h5jse){var h=window.location.protocol+r("ytplayer.config.assets.js");(h=Wg.getEntriesByName?Wg.getEntriesByName(h)[0]:null)?e.h5jse=
Math.round(e.h5jse-h.responseEnd):delete e.h5jse}d.aft=gh();var h=d._start,k=dh(),m=k.pbr,n=k.vc,k=k.pbs;m&&n&&k&&m<n&&n<k&&1==hh().info.yt_vis&&"youtube"==f&&(m=hh().info.yt_lt="hot_bg",eh().info_yt_lt=m,Zf("csi_on_gel")&&("yt_lt"in Zg?(f={},n=Zg.yt_lt,n in $g&&(m=!!m),f[n]=m,m=fh(),f.clientActionNonce=m,hg("latencyActionInfo",f)):cc(Error("Unknown label yt_lt logged with GEL CSI."))),f=d.vc,m=d.pbs,delete d.aft,e.aft=Math.round(m-f));for(var H in e)"_"!=H.charAt(0)&&(b[H]=e[H]);d.ps=ec();H={};var e=
[],R;for(R in d)"_"!=R.charAt(0)&&(f=Math.round(d[R]-h),Zf("enable_negative_ticks")||(f=Math.max(f,0)),H[R]=f,e.push(R+"."+f));b.rt=e.join(",");R=b;var d=[],ia;for(ia in a)"_"!=ia.charAt(0)&&d.push(ia+"."+Math.round(a[ia]));R.it=d.join(",");(ia=r("ytdebug.logTiming"))&&ia(b,H,a);Zf("navigation_only_csi_reset")||(jh(),ah(),kh(!1));F("EXP_DEFER_CSI_PING")?(lh(),q("yt.timing.deferredPingArgs_",b,void 0),ia=G(lh,0),q("yt.timing.deferredPingTimer_",ia,void 0)):ih(b);Q(Yg,new Xg(H.aft+(c||0)))}}}
