...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
    <div class="main-wrap">
        <div class="section block-2" style="padding-top: 0 !important; height: 600px;">
            <div style="width: 100%; padding-top: 20px; padding-bottom: 30px; text-align: center; background-color: white; font-size: 30px;">
                <div style="color:#ba4a8f; font-size: 35px;"><b>ВЫБЕРИТЕ МОДЕЛЬ</b></div><br>
                    <div>
                        <select class="cart_option">
                            <option value="">IPhone 5</option>
                            <option value="">IPhone 6</option>
                        </select>
                    </div><br><br>
<!--                    <img src="--><?php //echo SITE_DIR; ?><!--images/frontend/payment_methods/online_icon.png">-->
                    <div><span style="color:#ba4a8f; font-size: 35px;"><b>ВЫБЕРИТЕ ЦВЕТ</b></span> </div><br>
                    <div>
                        <select class="cart_option">
...
<!--            </div>-->
        ...
        <div class="center but-1">
            <form method="post">
                ...
                <a href="<?php echo SITE_DIR; ?>payment/methods/?id=<?php echo $order['id']; ?>" class="payment_btn"><b style="font-size: 32px;">790р</b> ОПЛАТИТЬ СЕЙЧАС</a><br>
