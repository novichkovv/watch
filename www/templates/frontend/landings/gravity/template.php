    ...
    <body>
            ...
            <div class="section block-1">
                <div class="container clearfix">
                    ...
                    <div class="cost">
                        <h4>Акция:</h4>
                        <span class="sale">-53%</span><br>
                        <span class="old-cost">4230р</span><br>
                        <span class="new-cost">1990р</span>
                    </div>
                </div>
            </div>
            ...
            <div class="section block-7">
                ...
                <div class="container">
                    <div class="deliv-item clearfix">
                        ...
                        <p>Доставка почтой, бандеролями 1-го класса, в течение 5-10 рабочих дней.<br>Стоимость доставки товара от 390р.</p>
                    </div>
                    <div class="deliv-item clearfix">
