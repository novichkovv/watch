...
countdown = document.getElementById("cd__tiles"), getCountdown(), setInterval(function() {
    getCountdown()
}, 1e3);
...
! function(t) {
    ...
    y.prototype = {
        ...
        open: function(i) {
            ...
            T("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (b(d, function(t, e, i, s) {
            ...
            return e.isIE7 && (v += " mfp-ie7"), v && e._addClassToMFP(v), e.updateItemHTML(), T("BuildControls"), t("html").css(u), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                e.content ? (e._addClassToMFP(f), e._setFocus()) : e.bgOverlay.addClass(f), s.on("focusin" + g, e._onFocusIn)
            }, 16), e.isOpen = !0, e.updateSize(h), T(p), i
        },
        close: function() {
        ...
        appendContent: function(t, i) {
            e.content = t, t ? e.st.showCloseBtn && e.st.closeBtnInside && e.currTemplate[i] === !0 ? e.content.find(".mfp-close").length || e.content.append(k()) : e.content = t : e.content = "", T(h), e.container.addClass("mfp-" + i + "-holder"), e.contentContainer.append(e.content)
        },
        parseEl: function(i) {
            var s, n = e.items[i];
            if (n.tagName ? n = {
        ...
        updateStatus: function(t, s) {
            if (e.preloader) {
                ...
                T("UpdateStatus", n), t = n.status, s = n.text, e.preloader.html(s), e.preloader.find("a").on("click", function(t) {
        ...
        _parseMarkup: function(e, i, s) {
            var n;
            s.data && (i = t.extend(s.data, i)), T(d, [e, i, s]), t.each(i, function(i, s) {
            ...
            getAjax: function(i) {
                ...
                var s = t.extend({
                    ...
                    success: function(s, n, o) {
                        ...
                        T("ParseAjax", r), e.appendContent(t(r.data), A), i.finished = !0, D(), e._setFocus(), setTimeout(function() {
                            e.wrap.addClass(f)
    ...
    t.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var i = e.st.image,
                    s = ".image";
                e.types.push("image"), b(p + s, function() {
            ...
            getImage: function(i, s) {
                var n = 0,
                    o = function() {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, T("ImageLoadComplete")) : (n++, n < 200 ? setTimeout(o, 100) : r()))
                    },
                    r = function() {
                ...
                }, i), e.resizeImage(), i.hasSize ? (j && clearInterval(j), i.loadError ? (s.addClass("mfp-loading"), e.updateStatus("error", a.tError.replace("%url%", i.src))) : (s.removeClass("mfp-loading"), e.updateStatus("ready")), s) : (e.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, s.addClass("mfp-loading"), e.findImageSize(i)), s)
            }
        }
    });
    var H, N = function() {
                ...
                if (i.enabled && e.supportsTransition) {
                    ...
                    b("BuildControls" + s, function() {
                        if (e._allowZoom()) {
                            ...
                            o = c(t), o.css(e._getOffset()), e.wrap.append(o), n = setTimeout(function() {
    ...
    t.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var i = e.st.gallery,
                    n = ".mfp-gallery";
                return e.direction = !0, !(!i || !i.enabled) && (o += " mfp-gallery", b(p + n, function() {
            ...
            _preloadItem: function(i) {
                if (i = Z(i), !e.items[i].preloaded) {
                    var s = e.items[i];
                    s.parsed || (s = e.parseEl(i)), T("LazyLoad", s), "image" === s.type && (s.img = t('<img class="mfp-img" />').on("load.mfploader", function() {
                        s.hasSize = !0
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var t = e.st.retina,
                        i = t.ratio;
                    i = isNaN(i) ? i() : i, i > 1 && (b("ImageHasSize." + Q, function(t, e) {
                        e.img.css({
    ...
    function(t, e, i, s) {
        ...
        n.Defaults = {
            ...
            t(i).off(".owl.core"), this.$element.removeClass(this.options.grabClass), (0 !== s.x && this.is("dragging") || !this.is("valid")) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed),
                this.current(this.closest(n.x, 0 !== s.x ? o : this._drag.direction)), this.invalidate("position"), this.update(), this._drag.direction = o, (Math.abs(s.x) > 3 || (new Date).getTime() - this._drag.time > 300) && this._drag.target.one("click.owl.core", function() {
                return !1
            ...
            var i = this.current(),
                ...
                a = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += o * -1 * r), t = i + n, s = ((t - a) % r + r) % r + a, s !== t && s - n <= l && s - n > 0 && (i = s - n, t = s, this.reset(i))) : this.settings.rewind ? (l += 1, t = (t % l + l) % l) : t = Math.max(a, Math.min(l, t)), this.speed(this.duration(i, t, e)), this.current(t), this.$element.is(":visible") && this.update()
            ...
            this._core = e, this._loaded = [], this._handlers = {
                "initialized.owl.carousel change.owl.carousel resized.owl.carousel": t.proxy(function(e) {
                    if (e.namespace && this._core.settings && this._core.settings.lazyLoad && (e.property && "position" == e.property.name || "initialized" == e.type))
                        for (var i = this._core.settings, n = i.center && Math.ceil(i.items / 2) || i.items, o = i.center && n * -1 || 0, r = (e.property && e.property.value !== s ? e.property.value : this._core.current()) + o, a = this._core.clones().length, l = t.proxy(function(t, e) {
                            this.load(e)
                        }, this); o++ < n;) this.load(a / 2 + this._core.relative(r)), a && t.each(this._core.clones(this._core.relative(r)), l), r++
                }, this)
            }, this._core.options = t.extend({}, n.Defaults, this._core.options), this._core.$element.on(this._handlers)
        };
        n.Defaults = {
    ...
    function(t, e, i, s) {
        ...
        n.Defaults = {
            ...
            var s, n, o, r = i.width && i.height ? 'style="width:' + i.width + "px;height:" + i.height + 'px;"' : "",
                ...
                d = function(t) {
                    n = '<div class="owl-video-play-icon"></div>', s = h.lazyLoad ? '<div class="owl-video-tn ' + c + '" ' + l + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>', e.after(s), e.after(n)
                };
            return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", c = "owl-lazy"), a.length ? (d(a.attr(l)), a.remove(), !1) : void("youtube" === i.type ? (o = "//img.youtube.com/vi/" + i.id + "/hqdefault.jpg", d(o)) : "vimeo" === i.type ? t.ajax({
                type: "GET",
    ...
    function(t, e, i) {
        ...
        s.prototype.init = function() {
            var i, s, n = this,
                o = t(this.element),
                a = this.settings;
            if (a.duplicate ? n.mobileNav = o.clone() : n.mobileNav = o, a.removeIds && (n.mobileNav.removeAttr("id"), n.mobileNav.find("*").each(function(e, i) {
                    t(i).removeAttr("id")
            ...
            t(c).each(function() {
                ...
                if (i.children = e.children("ul").attr("role", "menu"), e.data("menu", i), i.children.length > 0) {
                    ...
                    if (a.allowParentLinks && !a.nestedParentLinks && o) t(l).wrapAll('<span class="' + r + "_parent-link " + r + '_row"/>').parent();
                    else {
            ...
            var a = this,
                ...
                h = 0;
            s && (h = l.duration), e.hasClass(r + "_hidden") ? (e.removeClass(r + "_hidden"), o || l.beforeOpen(n), e.slideDown(h, l.easingOpen, function() {
                t(n).removeClass(r + "_animating"), t(i).removeClass(r + "_animating"), o || l.afterOpen(n)
            }), e.attr("aria-hidden", "false"), c.attr("tabindex", "0"), a._setVisAttr(e, !1)) : (e.addClass(r + "_hidden"), o || l.beforeClose(n), e.slideUp(h, this.settings.easingClose, function() {
    ...
    }(jQuery, document, window), $('a[href*="#scroll-"]:not([href="#"])').click(function() {
    ...
    console.info("Hey! Welcome to M1 landing page. Looking for something? Contact us at Skype: nikolya.m1-shop"), $(".slider-reviews").owlCarousel({
        items: 1,
        loop: !0,
        margin: 10,
        nav: !0,
